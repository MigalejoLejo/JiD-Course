package com.jid.migalejo.Seccion3.CodingExercise_2;
...
public class CarPriceEstimator {
    ...
    public static void main(String[] args) {
        ...
        double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2012, 5000.0, 2, true, true, true, false, false, false);
    }
}
